...
namespace LIRS {
    ...
    public:
        ...
        explicit Transcoder(lirs::config::params::CameraParameters const &config);
         ...
         */
        lirs::config::params::CameraParameters const &getConfig() const;
    ...
    private:
        ...
        lirs::config::params::CameraParameters const &config;
